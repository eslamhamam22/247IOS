...
class SlideShowVC: UIViewController, UIScrollViewDelegate {
    ...
    func createSlides() -> [Slide] {
        ...
        slide1.imageView.image = UIImage(named: "1_Splash")
        ...
        slide2.imageView.image = UIImage(named: "grayscale")
        ...
        slide3.imageView.image = UIImage(named: "1_Splash")
        ...
        slide4.imageView.image = UIImage(named: "howtouse_ic")
        ...
        slide5.imageView.image = UIImage(named: "grayscale")
...
//        pageControl.currentPage = pageControl.currentPage + 1
        scrollView.setContentOffset(CGPoint(x: scrollView.contentOffset.x + scrollView.contentOffset.x, y: scrollView.contentOffset.y), animated: false)
    }
