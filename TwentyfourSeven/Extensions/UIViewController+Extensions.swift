...
extension Dimmable where Self: UIViewController {
    ...
    func dimFullScreen(_ direction: Direction, color: UIColor = UIColor.black, alpha: CGFloat = 0.0, speed: Double = 0.0) {
        ...
        case .out:
            UIView.animate(withDuration: speed, animations: { () -> Void in
                self.navigationController?.view.subviews.last?.alpha = alpha
            }, completion: { (complete) -> Void in
